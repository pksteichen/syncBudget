...
object GroupManager {
    ...
    suspend fun joinGroup(context: Context, pairingCode: String): Boolean {
        ...
        val decryptedKey = try {
            com.techadvantage.budgetrak.data.CryptoHelper.decrypt(encryptedKeyBytes, normalizeCode(pairingCode))
        } catch (e: Exception) {
    ...
    suspend fun generatePairingCode(context: Context, groupId: String, encryptionKey: ByteArray): String {
        ...
        val encryptedKeyBytes = com.techadvantage.budgetrak.data.CryptoHelper.encrypt(encryptionKey, normalizeCode(code))
