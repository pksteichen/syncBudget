...
object EnglishStrings : AppStrings {
    ...
    override val settings = SettingsStrings(
        ...
        pickBackupFolderMessage = "Tap below to select your backup folder.\n\nDefault location: Download/BudgeTrak/backups/\n\nIf your backups are in cloud storage, download them to that folder first.",
        pickedFolderHasNoBackups = "No backup files in that folder. Pick the folder containing your backup_*_system.enc files (typically Download/BudgeTrak/backups/).",
        pickedFolderNotBackups = "Please pick the folder named 'backups' (typically Download/BudgeTrak/backups/). Selecting a parent folder won't show auto-backups stored in its subfolder.",
        ...
        aiOcrOffline = "Receipt scanner needs a network connection. Try again when you're online.",
        syncNowOffline = "No network connection. Sync will resume automatically when you're online.",
        ...
        aiOcrPreselectBanner = "Tap for important information about preselecting categories when using the AI receipt scanner.",
    ...
    override val dashboardHelp = DashboardHelpStrings(
        ...
        paidBody = "BudgeTrak has two upgrade tiers.",
        paidSubHeader = "The Paid User one-time purchase (\$9.99) removes ads and unlocks day-to-day power features:",
    ...
    override val transactionsHelp = TransactionsHelpStrings(
        ...
        addTransactionDesc = "Open the add-transaction dialog. Use the EXPENSE / INCOME pill in the dialog header to set the type.",
    ...
    override val ads = InHouseAdStrings(
        ...
        receiptsHeadline = "Capture every receipt",
        receiptsBody = "Snap photos of receipts, attach to transactions, and sync across all your devices.",
        exportsHeadline = "Take your data anywhere",
        exportsBody = "Export to CSV, XLSX, or PDF for taxes, accountants, and spreadsheet apps.",
        syncHeadline = "Budget together",
        syncBody = "Share a household budget across up to 5 devices with real-time encrypted sync.",
        simulationHeadline = "See months ahead",
