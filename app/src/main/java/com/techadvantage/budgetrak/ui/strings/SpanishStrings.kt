...
object SpanishStrings : AppStrings {
    ...
    override val settings = SettingsStrings(
        ...
        pickBackupFolderMessage = "Toca abajo para seleccionar tu carpeta de respaldos.\n\nUbicaci\u00f3n predeterminada: Download/BudgeTrak/backups/\n\nSi tus respaldos est\u00e1n en almacenamiento en la nube, desc\u00e1rgalos primero a esa carpeta.",
        pickedFolderHasNoBackups = "No hay archivos de respaldo en esa carpeta. Selecciona la carpeta que contenga tus archivos backup_*_system.enc (normalmente Download/BudgeTrak/backups/).",
        pickedFolderNotBackups = "Por favor, selecciona la carpeta llamada 'backups' (normalmente Download/BudgeTrak/backups/). Si eliges una carpeta principal, los respaldos autom\u00e1ticos en la subcarpeta no aparecer\u00e1n.",
        ...
        aiOcrOffline = "El esc\u00e1ner de recibos necesita conexi\u00f3n. Int\u00e9ntalo de nuevo cuando est\u00e9s en l\u00ednea.",
        syncNowOffline = "Sin conexi\u00f3n. La sincronizaci\u00f3n se reanudar\u00e1 autom\u00e1ticamente cuando est\u00e9s en l\u00ednea.",
        ...
        aiOcrPreselectBanner = "Toca para informaci\u00f3n importante sobre la preselecci\u00f3n de categor\u00edas al usar el escaneo de recibos con IA.",
    ...
    override val dashboardHelp = DashboardHelpStrings(
        ...
        paidBody = "BudgeTrak tiene dos niveles de mejora.",
        paidSubHeader = "La compra \u00fanica de Usuario de Pago (\$9.99) elimina los anuncios y desbloquea funciones de uso diario:",
    ...
    override val transactionsHelp = TransactionsHelpStrings(
        ...
        addTransactionDesc = "Abre el cuadro de di\u00e1logo para a\u00f1adir transacci\u00f3n. Usa la p\u00edldora GASTOS / INGRESO en el encabezado para establecer el tipo.",
    ...
    override val ads = InHouseAdStrings(
        ...
        receiptsBody = "Adjunta fotos de recibos a transacciones y sincron\u00edzalos en todos los dispositivos.",
        exportsHeadline = "Lleva tus datos donde sea",
        exportsBody = "Exporta a CSV, XLSX o PDF para impuestos, contadores y hojas de c\u00e1lculo.",
        syncHeadline = "Presupuesta en familia",
        syncBody = "Comparte un presupuesto familiar entre 5 dispositivos con sincronizaci\u00f3n cifrada.",
