...
- [Gemini API key — restrictions + rotation gotcha](reference_gemini_api_key.md) — locked to Android cert + Gemini-only since 2026-05-12; new keys (post-policy-change) require SA binding before API restriction can be applied. Console renamed "Generative Language API" → "Gemini API".
